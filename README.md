...
### Downloads:
  * [ks-tools-6.9-230321-Linux-en.tar.gz](https://github.com/q3aql/ks-tools/releases/download/v6.9/ks-tools-6.9-230321-Linux-en.tar.gz) - Unix/Linux package.
  * [ks-tools-6.9-230321-Windows-en.zip](https://github.com/q3aql/ks-tools/releases/download/v6.9/ks-tools-6.9-230321-Windows-en.zip) - Windows package (with cygwin).
  * [ks-tools-6.9-230321-en-all.deb](https://github.com/q3aql/ks-tools/releases/download/v6.9/ks-tools-6.9-230321-en-all.deb) - Debian based package.
  * [ks-tools-6.9-230321-en-all.rpm](https://github.com/q3aql/ks-tools/releases/download/v6.9/ks-tools-6.9-230321-en-all.rpm) - Red Hat based package.
...
### Installation:
  ...
  * **Unix/Linux instructions:**
    * Open the terminal.
    * Type the command: `tar zxvf ks-tools-6.9-230321-Linux-en.tar.gz`

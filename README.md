...
### Downloads:
  * [ks-tools-6.8-220321-Linux-en.tar.gz](https://github.com/q3aql/ks-tools/releases/download/v6.8/ks-tools-6.8-220321-Linux-en.tar.gz) - Unix/Linux package.
  * [ks-tools-6.8-220321-Windows-en.zip](https://github.com/q3aql/ks-tools/releases/download/v6.8/ks-tools-6.8-220321-Windows-en.zip) - Windows package (with cygwin).
  * [ks-tools-6.8-220321-en-all.deb](https://github.com/q3aql/ks-tools/releases/download/v6.8/ks-tools-6.8-220321-en-all.deb) - Debian based package.
  * [ks-tools-6.8-220321-en-all.rpm](https://github.com/q3aql/ks-tools/releases/download/v6.8/ks-tools-6.8-220321-en-all.rpm) - Red Hat based package.
...
### Installation:
  ...
  * **Unix/Linux instructions:**
    * Open the terminal.
    * Type the command: `tar zxvf ks-tools-6.8-220321-Linux-en.tar.gz`
